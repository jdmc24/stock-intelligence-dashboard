...
export default function EarningsToolsPage() {
    ...
    <div className="page-canvas relative overflow-hidden">
      ...
      <main className="relative mx-auto max-w-5xl px-4 py-10 sm:px-6">
        ...
        <div className="flex max-w-2xl flex-col gap-2">
          <Link href="/" className="text-xs font-medium text-teal-600 hover:underline dark:text-teal-400">
            ← Back to Ask
          </Link>
          ...
          <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
            Fetch transcripts, run AI analysis, and compare quarters. Company regulatory profiles are created
            automatically when you Ask about a ticker.
          </p>
        </div>
                      ...
                      <div className="rounded-xl border border-zinc-200/90 px-3 py-2 dark:border-zinc-800">
                        ...
                        {impact === undefined ? (
                          ...
                          <p className="mt-1.5 text-[11px] text-zinc-500">
                            Ask about <span className="font-mono">{tk}</span> on the{" "}
                            <Link href="/" className="text-teal-600 hover:underline dark:text-teal-400">
                              home page
                            </Link>{" "}
                            to infer a regulatory profile.
                          </p>
                        ) : top ? (
